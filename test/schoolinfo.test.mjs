...
test('builds a safely encoded Schoolinfo search URL from a trimmed school name', () => {
  assert.equal(
    ...
    'https://www.schoolinfo.go.kr/ei/ss/Pneiss_f01_l0.do?SEARCH_KEYWORD=%EC%84%9C%EC%9A%B8+%26+%EB%B6%80%EC%82%B0+%EC%B4%88%EB%93%B1%ED%95%99%EA%B5%90&SEARCH_SCHUL_NM=%EC%84%9C%EC%9A%B8+%26+%EB%B6%80%EC%82%B0+%EC%B4%88%EB%93%B1%ED%95%99%EA%B5%90'
  );
});
...
test('rejects unsafe persisted URLs and falls back to ID or school name', () => {
  ...
  assert.equal(
    ...
    'https://www.schoolinfo.go.kr/ei/ss/Pneiss_f01_l0.do?SEARCH_KEYWORD=%EC%84%9C%EC%9A%B8%EC%B4%88%EB%93%B1%ED%95%99%EA%B5%90&SEARCH_SCHUL_NM=%EC%84%9C%EC%9A%B8%EC%B4%88%EB%93%B1%ED%95%99%EA%B5%90'
  );
  assert.equal(
